@echo off
:: WinGet Install: .NET Desktop Runtime 10
:: Package ID: Microsoft.DotNet.DesktopRuntime.10
...
echo ============================================================
echo  WinGet Install: .NET Desktop Runtime 10
echo  Package ID: Microsoft.DotNet.DesktopRuntime.10
echo ============================================================
echo.
