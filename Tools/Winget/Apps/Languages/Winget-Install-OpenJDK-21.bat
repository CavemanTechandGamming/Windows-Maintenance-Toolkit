@echo off
:: WinGet Install: Microsoft OpenJDK 21 (Java LTS)
:: Package ID: Microsoft.OpenJDK.21
...
echo ============================================================
echo  WinGet Install: Microsoft OpenJDK 21 (Java LTS)
echo  Package ID: Microsoft.OpenJDK.21
echo ============================================================
echo.
